...
public class Grid_Test_Chrome {
    ...
    public void login_test() throws InterruptedException, MalformedURLException {
        ...
        //Create chrome browser object from Desired Capabilities object
        DesiredCapabilities capability = DesiredCapabilities.chrome();
        //Set chrome options
        capability.setCapability(ChromeOptions.CAPABILITY, "/Users/tulachanashok/Documents/Udemy-Selenium-Java/udemyseleniumjava/chromedriver");
